	...
	<table width="1024" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
				...
				<tr>
					<td width="32%" class="style3">
						<strong>Número Contrato:<font color="#FF0000">*</font></strong>
					</td>
				...
				<tr>
					...
					ISS <html:radio property="indicadorCobranca" value="2" tabindex="7" />Não
				...
				<tr>
					...
					<a href="javascript:abrirCalendarioReplicando('AtualizarContratoArrecadadorActionForm', 'dtInicioContrato', 'dtFimContrato');">
						<img border="0"
							...
							width="20" border="0" align="absmiddle" alt="Exibir Calendário" title="Exibir Calendário" />
					</a>
					dd/mm/aaaa</td>
				</tr>
