...
<form action="/gsan/gerarOrdemCorteAction.do"
			...
			<tr>
				<td align="left">
					<input name="Button" 
						...
						value="Desfazer" 
						align="left"
						onclick="window.location.href='<html:rewrite page="/exibirGerarOrdemCorteAction.do?menu=sim"/>'">
						&nbsp;
