	               ...
	               <tr>
		                ...
		                <td colspan="2"><strong>
			                <html:text maxlength="3"
			                  			 ...
			                  			 tabindex="1"
			                  			 property="idQuadra"
			                  			 onkeypress="javascript:validaEnterDependencia(event, 'exibirMotivoNaoGeracaoDocumentoTipoComandoCronogramaAction.do?pesquisarQuadra=OK',this,document.forms[0].idSetorComercial.value, 'Setor Comercial');" />
