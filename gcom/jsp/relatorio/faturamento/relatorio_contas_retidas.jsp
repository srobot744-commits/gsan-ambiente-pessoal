...
<html:form action="/gerarRelatorioContasRetidasAction.do"
	name="RelatorioContasRetidasActionForm"
	type="gcom.gui.relatorio.faturamento.RelatorioContasRetidasActionForm" method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Relatório de Contas Retidas </td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para gerar o relatório de contas retidas, informe os dados abaixo:</td>
				</tr>
        		...
        		<tr>
		         	<td>
		         		<input type="button" name="Button" class="bottonRightCol" value="Limpar" onclick="window.location.href='<html:rewrite page="/exibirFiltrarRelatorioContasRetidas.do?menu=sim"/>'">
		         	</td>
          			<td><div align="right">
          				<div align="right">
