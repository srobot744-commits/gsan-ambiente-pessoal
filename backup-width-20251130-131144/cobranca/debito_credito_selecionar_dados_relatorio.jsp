	...
	<td width="625" valign="top" class="centercoltext">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td class="parabg">Simulador de Débitos</td>
	  ...
	  <table width="100%" border="0">
		<tr>
			...
			<td>
				...
				onkeypress="validaEnterComMensagem(event, 'exibirDebitoCreditoDadosSelecaoRelatorioAction.do?pesquisarImovel=SIM', 'idImovel', 'Matrícula');return isCampoNumerico(event);" /> 
