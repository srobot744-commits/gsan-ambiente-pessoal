...
function validarForm(tipo){
	   ...
	   if(ok ==1 || temPreenchido == 0){
		   if(tipo == 1){
		   		form.action = 'informarLeituraRotaAction.do?action=avancar&temPreenchido='+temPreenchido;
		   }else if(tipo == 2){
		   		form.action = 'informarLeituraRotaAction.do?action=voltar&temPreenchido='+temPreenchido;
		   }else if(tipo == 3){
		   		form.action = 'informarLeituraRotaAction.do?action=concluir&temPreenchido='+temPreenchido;
		   }
