...
<html:form action="/gerarRelatorioMedicaoFaturamentoAction.do"
	name="RelatorioMedicaoFaturamentoActionForm"
	type="gcom.gui.relatorio.faturamento.RelatorioMedicaoFaturamentoActionForm" method="post">
		...
		<tr>
			...
			<table width="100%" border="0" align="center" cellpadding="0"
				...
				<tr>
					...
					<td class="parabg">Relatório de Medição do Faturamento </td>
			...
			<table width="100%" border="0">
				<tr>
					<td colspan="2">Para gerar o relatório de medição do faturamento, informe os dados abaixo:</td>
				</tr>
        		...
        		<tr>
          			...
          			<td width="70%">
          				<html:select property="idEmpresa">
          					<html:option value="-1">&nbsp;</html:option>
             	 			<html:options collection="empresas" labelProperty="descricao" property="id"/>
             			</html:select>
          			</td>
        		</tr>
        		...
        		<tr>
		         	<td>
		         		<input type="button" name="Button" class="bottonRightCol" value="Limpar" onclick="window.location.href='<html:rewrite page="/exibirFiltrarRelatorioMedicaoFaturamento.do?menu=sim"/>'">
		         	</td>
          			<td><div align="right">
          				<div align="right">
