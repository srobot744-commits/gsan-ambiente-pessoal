...
<script language="JavaScript">
	...
	function habilitaMatricula() {
		...
		if (form.idImovelRegistroAtendimento.value != null
				...
				&& form.matriculaImovelRegistroAtendimento.value != "IMÓVEL INEXISTENTE") {
		...
		<table width="1024" border="0" cellspacing="5" cellpadding="0">
			<tr>
				...
				<td width="675" valign="top" class="centercoltext">
					...
					<p>&nbsp;</p> <!-- Início do Corpo - Fernanda Paiva  07/02/2006  -->
											...
											<table width="100%" align="center" bgcolor="#99CCFF"
												...
												<tr>
													...
													<td align="center" width="96%"><strong>Dados
															do Imóvel<logic:present name="imovelExcluido"
																scope="request">
																<font color="#ff0000"> (Excluído)</font>
															</logic:present>
													</strong></td>
												</tr>
											</table>
						...
						<tr>
							<td align="center">
								...
								<table width="100%" border="0" bgcolor="#90c7fc">
									...
									<tr bgcolor="#79bbfd">
										<td height="18" colspan="6" align="center"><strong>Dados
												Gerais de Ordens de Serviço Seletivas</strong></td>
									</tr>
							...
							<td align="center">
								...
								<table width="100%" bgcolor="#90c7fc" border="0">
									...
									<tr bordercolor="#79bbfd">
										<td colspan="3" align="center" bgcolor="#79bbfd"><strong>Fotos de Ordens de Serviços</strong></td>
									</tr>
