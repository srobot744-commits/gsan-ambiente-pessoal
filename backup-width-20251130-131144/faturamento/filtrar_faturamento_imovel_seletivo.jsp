...
<html:form action="/filtrarFaturamentoImovelSeletivo"
	name="FaturamentoImovelSeletivoActionForm"
	type="gcom.gui.faturamento.FaturamentoImovelSeletivoActionForm"
	method="post">
		...
		<tr>
			...
			<td width="660" valign="top" class="centercoltext">
				...
				<table width="100%" border="0">
					<tr>
						<td colspan="3">Para realizar o faturamento seletivo, informe o campo abaixo:</td>
						<td align="right"></td>
					</tr>
				</table>
