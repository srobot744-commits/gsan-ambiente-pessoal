...
<form action="/gsan/atualizarDadosCelularAction.do"
			...
			<tr>
				<td align="left">
					<input name="Button" 
						...
						value="Desfazer" 
						align="left"
						onclick="window.location.href='<html:rewrite page="/exibiratualizarDadosCelularAction.do?menu=sim"/>'">
						&nbsp;
				...
				<td align="right">
					<gsan:controleAcessoBotao name="Button" 
				  		...
				  		url="atualizarDadosCelularAction.do"/>
