...
<html:javascript staticJavascript="false"
	formName="FiltrarDadosDiariosArrecadacaoComTarifaActionForm"
...
function validateFiltrarDadosDiariosArrecadacaoComTarifaActionForm(form) {                                                                   
	if (bCancel) 
		return true; 
	else 
...
{
	var form = document.FiltrarDadosDiariosArrecadacaoComTarifaActionForm;
...
function limparLocalidade() {
	...
	controleEloLocalidade(document.FiltrarDadosDiariosArrecadacaoComTarifaActionForm);
}
function limparElo() {
	var form = document.FiltrarDadosDiariosArrecadacaoComTarifaActionForm;
	form.idElo.value = "";
...
{
	var retorno = true;
	urlRedirect = "/gsan/filtrarDadosDiariosArrecadacaoComTarifaAction.do"
	...
	if (validateFiltrarDadosDiariosArrecadacaoComTarifaActionForm(form))
	{
...
<html:form action="/exibirFiltrarDadosDiariosArrecadacaoComTarifaAction"
	...
	onsubmit="return validateFiltrarDadosDiariosArrecadacaoComTarifaActionForm(this);"
	...
	<table width="1024" border="0" cellspacing="5" cellpadding="0">
		<tr>
			...
			<table width="100%" border="0">
					...
					<table width="100%" border="0">
						...
						<tr>
							...
							<td width="74%"><html:text property="idElo" size="5"
								maxlength="3"
								onkeyup="limparLocalidadeDoElo(document.forms[0].localidade, document.forms[0].descricaoLocalidade); validaEnterComMensagem(event, 'exibirFiltrarDadosDiariosArrecadacaoComTarifaAction.do', 'idElo', 'Elo Pólo');"
						...
						<tr>
							...
							<td><strong> <html:text property="localidade" size="5"
								maxlength="3"
								onkeyup="return validaEnterComMensagem(event, 'exibirFiltrarDadosDiariosArrecadacaoComTarifaAction.do', 'localidade', 'Localidade');"
								onchange="controleEloLocalidade(this.value);" 
								onkeypress="return isCampoNumerico(event);"/> <a
						...
						<tr>
							...
							<td><strong> <html:text property="idArrecadador" size="5"
								maxlength="3"
								onkeyup="return validaEnterComMensagem(event, 'exibirFiltrarDadosDiariosArrecadacaoComTarifaAction.do', 'idArrecadador', 'Arrecadador');" 
								onkeypress="return isCampoNumerico(event);"/>
							<a
				...
				<tr>
					<td>
						<input value="Limpar" class="bottonRightCol" type="button" onclick="javascript:window.location.href='/gsan/exibirFiltrarDadosDiariosArrecadacaoComTarifaAction.do?menu=sim'">
					...
					<td align="right"><html:hidden
						...
						url="filtrarDadosDiariosArrecadacaoComTarifaAction.do" /> <%-- <input value="Filtrar" class="bottonRightCol" type="button" onclick="validarForm(document.forms[0]);"> --%>
					</td>
				</tr>
				<tr>
